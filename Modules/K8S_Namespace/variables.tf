...
variable "quota" {
  description = "Map of string key default pairs that can be used to quota. See the Kubernetes Reference for more info (https://kubernetes.io/docs/concepts/policy/resource-quotas/)."
  type        = map(string)
  default     = {}
}
